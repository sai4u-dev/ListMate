        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/categories/dairy" className="text-muted-foreground hover:text-primary">
                  Dairy
                </Link>
              </li>
              <li>
                <Link href="/categories/fruits" className="text-muted-foreground hover:text-primary">
                  Fruits
                </Link>
              </li>
              <li>
                <Link href="/categories/vegetables" className="text-muted-foreground hover:text-primary">
                  Vegetables
                </Link>
              </li>
              <li>
                <Link href="/categories/featured" className="text-muted-foreground hover:text-primary">
                  Featured Products
                </Link>
              </li>
            </ul>
